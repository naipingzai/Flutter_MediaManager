package com.naipingzai.fmv.channel.calls
...
import com.naipingzai.fmv.channel.calls.Coresult.Companion.safe
import com.naipingzai.fmv.metadata.ExifGeoTiffTags
import com.naipingzai.fmv.metadata.ExifInterfaceHelper
import com.naipingzai.fmv.metadata.ExifInterfaceHelper.describeAll
import com.naipingzai.fmv.metadata.ExifInterfaceHelper.getSafeDateMillis
import com.naipingzai.fmv.metadata.ExifInterfaceHelper.getSafeDouble
import com.naipingzai.fmv.metadata.ExifInterfaceHelper.getSafeInt
import com.naipingzai.fmv.metadata.ExifInterfaceHelper.getSafeRational
import com.naipingzai.fmv.metadata.ExifTags
import com.naipingzai.fmv.metadata.GSpherical
import com.naipingzai.fmv.metadata.GeoTiffKeys
import com.naipingzai.fmv.metadata.MediaMetadataRetrieverHelper
import com.naipingzai.fmv.metadata.MediaMetadataRetrieverHelper.getSafeDateMillis
import com.naipingzai.fmv.metadata.MediaMetadataRetrieverHelper.getSafeDescription
import com.naipingzai.fmv.metadata.MediaMetadataRetrieverHelper.getSafeDouble
import com.naipingzai.fmv.metadata.MediaMetadataRetrieverHelper.getSafeInt
import com.naipingzai.fmv.metadata.Metadata
import com.naipingzai.fmv.metadata.Metadata.DIR_DNG
import com.naipingzai.fmv.metadata.Metadata.DIR_EXIF_GEOTIFF
import com.naipingzai.fmv.metadata.Metadata.DIR_PNG_TEXTUAL_DATA
import com.naipingzai.fmv.metadata.Metadata.getRotationDegreesForExifCode
import com.naipingzai.fmv.metadata.Metadata.isFlippedForExifCode
import com.naipingzai.fmv.metadata.Mp4ParserHelper
import com.naipingzai.fmv.metadata.MultiPage
import com.naipingzai.fmv.metadata.PixyMetaHelper
import com.naipingzai.fmv.metadata.QuickTimeMetadata
import com.naipingzai.fmv.metadata.metadataextractor.Helper.PNG_ITXT_DIR_NAME
import com.naipingzai.fmv.metadata.metadataextractor.Helper.PNG_LAST_MODIFICATION_TIME_FORMAT
import com.naipingzai.fmv.metadata.metadataextractor.Helper.PNG_TIME_DIR_NAME
import com.naipingzai.fmv.metadata.metadataextractor.Helper.containsGeoTiffTags
import com.naipingzai.fmv.metadata.metadataextractor.Helper.extractGeoKeys
import com.naipingzai.fmv.metadata.metadataextractor.Helper.extractPngProfile
import com.naipingzai.fmv.metadata.metadataextractor.Helper.getDateDigitizedMillis
import com.naipingzai.fmv.metadata.metadataextractor.Helper.getDateModifiedMillis
import com.naipingzai.fmv.metadata.metadataextractor.Helper.getDateOriginalMillis
import com.naipingzai.fmv.metadata.metadataextractor.Helper.getSafeBoolean
import com.naipingzai.fmv.metadata.metadataextractor.Helper.getSafeDateMillis
import com.naipingzai.fmv.metadata.metadataextractor.Helper.getSafeInt
import com.naipingzai.fmv.metadata.metadataextractor.Helper.getSafeRational
import com.naipingzai.fmv.metadata.metadataextractor.Helper.getSafeString
import com.naipingzai.fmv.metadata.metadataextractor.Helper.isPngTextDir
import com.naipingzai.fmv.metadata.metadataextractor.PngActlDirectory
import com.naipingzai.fmv.metadata.metadataextractor.SafeXmpReader
import com.naipingzai.fmv.metadata.metadataextractor.mpf.MpEntry
import com.naipingzai.fmv.metadata.metadataextractor.mpf.MpEntryDirectory
import com.naipingzai.fmv.metadata.xmp.GoogleXMP
import com.naipingzai.fmv.metadata.xmp.XMP
import com.naipingzai.fmv.metadata.xmp.XMP.doesPropExist
import com.naipingzai.fmv.metadata.xmp.XMP.getPropArrayItemValues
import com.naipingzai.fmv.metadata.xmp.XMP.getSafeDateMillis
import com.naipingzai.fmv.metadata.xmp.XMP.getSafeInt
import com.naipingzai.fmv.metadata.xmp.XMP.getSafeLocalizedText
import com.naipingzai.fmv.metadata.xmp.XMP.hasHdrGainMap
import com.naipingzai.fmv.metadata.xmp.XMP.isMotionPhoto
import com.naipingzai.fmv.metadata.xmp.XMP.isPanorama
import com.naipingzai.fmv.model.FieldMap
import com.naipingzai.fmv.utils.ContextUtils.queryContentPropValue
import com.naipingzai.fmv.utils.HashUtils
import com.naipingzai.fmv.utils.LogUtils
import com.naipingzai.fmv.utils.MimeTypes
import com.naipingzai.fmv.utils.MimeTypes.TIFF_EXTENSION_PATTERN
import com.naipingzai.fmv.utils.MimeTypes.canReadWithExifInterface
import com.naipingzai.fmv.utils.MimeTypes.canReadWithMetadataExtractor
import com.naipingzai.fmv.utils.MimeTypes.isIsoBMFFImage
import com.naipingzai.fmv.utils.MimeTypes.isVideo
...
import com.naipingzai.fmv.metadata.metadataextractor.Helper as MetadataExtractorHelper
