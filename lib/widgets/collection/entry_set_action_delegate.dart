...
import 'package:flutter_media_view/model/device.dart';
import 'package:flutter_media_view/model/dynamic_albums.dart';
import 'package:flutter_media_view/model/entry/entry.dart';
import 'package:flutter_media_view/model/entry/extensions/favourites.dart';
import 'package:flutter_media_view/model/entry/extensions/location.dart';
import 'package:flutter_media_view/model/entry/extensions/metadata_edition.dart';
import 'package:flutter_media_view/model/entry/extensions/multipage.dart';
...
import 'package:flutter_media_view/model/filters/container/dynamic_album.dart';
import 'package:flutter_media_view/model/filters/container/set_and.dart';
...
import 'package:flutter_media_view/model/metadata/date_modifier.dart';
import 'package:flutter_media_view/model/naming_pattern.dart';
import 'package:flutter_media_view/model/query.dart';
import 'package:flutter_media_view/model/selection.dart';
import 'package:flutter_media_view/model/settings/settings.dart';
import 'package:flutter_media_view/model/source/analysis_controller.dart';
...
import 'package:flutter_media_view/model/vaults/vaults.dart';
import 'package:flutter_media_view/ref/locales.dart';
import 'package:flutter_media_view/ref/mime_types.dart';
import 'package:flutter_media_view/services/app_service.dart';
import 'package:flutter_media_view/services/common/image_op_events.dart';
import 'package:flutter_media_view/services/common/services.dart';
import 'package:flutter_media_view/services/intent_service.dart';
import 'package:flutter_media_view/services/media/media_edit_service.dart';
import 'package:flutter_media_view/theme/durations.dart';
import 'package:flutter_media_view/utils/mime_utils.dart';
import 'package:flutter_media_view/widgets/about/app_ref.dart';
import 'package:flutter_media_view/widgets/collection/collection_page.dart';
import 'package:flutter_media_view/widgets/common/action_mixins/entry_editor.dart';
import 'package:flutter_media_view/widgets/common/action_mixins/entry_storage.dart';
import 'package:flutter_media_view/widgets/common/action_mixins/feedback.dart';
import 'package:flutter_media_view/widgets/common/action_mixins/permission_aware.dart';
import 'package:flutter_media_view/widgets/common/action_mixins/size_aware.dart';
import 'package:flutter_media_view/widgets/common/action_mixins/vault_aware.dart';
import 'package:flutter_media_view/widgets/common/extensions/build_context.dart';
import 'package:flutter_media_view/widgets/dialogs/add_shortcut_dialog.dart';
...
import 'package:flutter_media_view/widgets/dialogs/convert_entry_dialog.dart';
import 'package:flutter_media_view/widgets/dialogs/entry_editors/rename_entry_set_page.dart';
import 'package:flutter_media_view/widgets/dialogs/filter_editors/create_dynamic_album_dialog.dart';
import 'package:flutter_media_view/widgets/dialogs/pick_dialogs/location_pick_page.dart';
import 'package:flutter_media_view/widgets/filter_grids/albums_page.dart';
import 'package:flutter_media_view/widgets/map/map_page.dart';
import 'package:flutter_media_view/widgets/search/collection_search_page_route.dart';
import 'package:flutter_media_view/widgets/stats/stats_page.dart';
import 'package:flutter_media_view/widgets/viewer/slideshow_page.dart';
...
class EntrySetActionDelegate with FeedbackMixin, PermissionAwareMixin, SizeAwareMixin, EntryEditorMixin, EntryStorageMixin, VaultAwareMixin {
  ...
  Future<void> _importMedia(BuildContext context) async {
    ...
    try {
      files = await importService.pickFiles();
    } catch (e, stack) {
      debugPrint('ImportService failed: $e');
      await reportService.recordError(e, stack);
      messenger.showSnackBar(SnackBar(content: Text(l10n.collectionActionImportFailed)));
      return;
    }

    if (files.isEmpty) return;

    await showOpReport<String>(
      context: context,
      opStream: importService.importFiles(files),
      itemCount: files.length,
      onDone: (processed) async {
        final uris = processed.toSet();
        if (uris.isNotEmpty) {
          // 触发刷新：让新导入的文件出现在集合中
          await collection.source.refreshUris(uris);
        }
        if (uris.isEmpty) {
          messenger.showSnackBar(SnackBar(content: Text(l10n.collectionActionImportFailed)));
        } else {
          messenger.showSnackBar(
            SnackBar(content: Text(l10n.collectionActionImportDone(uris.length))),
          );
        }
      },
    );
