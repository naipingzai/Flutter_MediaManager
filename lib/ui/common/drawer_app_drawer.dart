...
import 'package:fmv/ui/about/page.dart';
import 'package:fmv/ui/collection/page.dart';
import 'package:fmv/ui/common/basic/basic_text_outlined.dart';
...
import 'package:fmv/ui/collection/drawer_nav_tile.dart';
import 'package:fmv/ui/common/drawer_page_nav_tile.dart';
...
class _AppDrawerState extends State<AppDrawer> with WidgetsBindingObserver {
  ...
  Widget binTile(BuildContext context) {
    ...
    return CollectionNavTile(
      ...
      trailing: Text(formatFileSize(settings.fmvLocale, trashSize, round: 0)),
      filters: {filter},
