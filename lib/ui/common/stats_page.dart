...
import 'package:fmv/ui/collection/dialogs_export_stats_page.dart';
import 'package:fmv/ui/common/stats_date_histogram.dart';
import 'package:fmv/ui/filter/stats_filter_table.dart';
import 'package:fmv/ui/common/stats_mime_donut.dart';
import 'package:fmv/ui/common/stats_percent_text.dart';
import 'package:fmv/ui/common/stats_top_page.dart';
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(formatFileSize(settings.fmvLocale, _totalSizeBytes)),
          ),
        ],
      ),
    );
