...
import 'package:flutter_media_view/function/services/wallpaper_service.dart';
...
import 'package:flutter_media_view/ui/settings/dialogs_wallpaper_settings_dialog.dart';
  ...
  Future<Uint8List?> _getBytes(BuildContext context, Rect displayRegion) async {
    ...
    if (entry.isSvg) {
      ...
      if (entry.useTiles) {
        ...
        final sampleSize = ExtraFmvEntryImages.sampleSizeForScale(magnifierScale: scale, devicePixelRatio: devicePixelRatio);
