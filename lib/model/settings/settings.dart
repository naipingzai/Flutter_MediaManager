...
import 'package:flutter_media_view/model/settings/modules/app.dart';
import 'package:flutter_media_view/model/settings/modules/collection.dart';
import 'package:flutter_media_view/model/settings/modules/debug.dart';
import 'package:flutter_media_view/model/settings/modules/display.dart';
import 'package:flutter_media_view/model/settings/modules/filter_grids.dart';
import 'package:flutter_media_view/model/settings/modules/history.dart';
import 'package:flutter_media_view/model/settings/modules/info.dart';
import 'package:flutter_media_view/model/settings/modules/map.dart';
import 'package:flutter_media_view/model/settings/modules/navigation.dart';
import 'package:flutter_media_view/model/settings/modules/privacy.dart';
import 'package:flutter_media_view/model/settings/modules/screen_saver.dart';
import 'package:flutter_media_view/model/settings/modules/slideshow.dart';
import 'package:flutter_media_view/model/settings/modules/viewer.dart';
import 'package:flutter_media_view/model/settings/modules/widget.dart';
import 'package:flutter_media_view/ref/bursts.dart';
...
import 'package:flutter_media_view/widgets/filter_grids/places_page.dart';
