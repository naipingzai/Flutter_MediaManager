...
@immutable
class FmvXmp extends Equatable {
  ...
  static FmvXmp fromList(List<String> xmpStrings) {
    switch (xmpStrings.length) {
      case 0:
        return const FmvXmp(xmpString: null);
      case 1:
        return FmvXmp(xmpString: xmpStrings.single);
      default:
        ...
        return FmvXmp(xmpString: xmpStrings.firstOrNull);
    }
  }
}
